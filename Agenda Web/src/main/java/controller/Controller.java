...
public class Controller extends HttpServlet {
	...
	protected void editarContato(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// Passos 13|14 - slide 23 (Receber os dados do forms e setar JavaBeans)
		// request.getParameter (13) | javabeans.set (14)
		javabeans.setIdcon(request.getParameter("idcon"));
		javabeans.setNome(request.getParameter("nome"));
		javabeans.setFone(request.getParameter("fone"));
		javabeans.setEmail(request.getParameter("email"));
		// Passo - slide 23 (executar o metodo alterarContato
	...
	protected void removerContato(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// Passo 3 - slide 24 (Setar o id con em JavaBeans)
		javabeans.setIdcon(request.getParameter("idcon"));
		dao.deletarContato(javabeans); //Passo 4 - slide 24
		response.sendRedirect("main"); //passo 8 - slide 24
	}
}
